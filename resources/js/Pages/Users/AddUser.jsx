...
export default function AddUser({ onUserAdded }) {
    ...
    const handleChange = (e) => {
        ...
        if (sameAddress && name === 'current_address') {
            updatedForm.permanent_address = value;
        }
    ...
    const handleSubmit = (e) => {
        ...
        // ✅ Validate phone and alternate phone must not be same
        if (form.phone && form.alternate_phone && form.phone === form.alternate_phone) {
            newErrors.alternate_phone = ['Phone and alternate phone must be different'];
        }
            ...
            <form onSubmit={handleSubmit} className="mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        {errors.alternate_phone && (
                            <div className="text-red-500 text-sm">{errors.alternate_phone[0]}</div>
                        )}
                    </div>
                ...
                <div className="mt-4">
                    ...
                    {errors.current_address && (
                        <div className="text-red-500 text-sm">{errors.current_address[0]}</div>
                    )}
                </div>
                ...
                <div className="mt-2 flex items-center">
                    <input
                        ...
                        className="mr-2"
                    />
                    <label className="text-sm">Permanent address is same as current address</label>
                </div>
                ...
                <div className="mt-4">
                    ...
                    {errors.permanent_address && (
                        <div className="text-red-500 text-sm">{errors.permanent_address[0]}</div>
                    )}
                </div>
